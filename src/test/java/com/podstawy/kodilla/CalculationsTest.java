...
public class CalculationsTest {
    ...
    public void testCalculateBestAverage() {
        ...
        //then
        Assertions.assertEquals(4.117, result, 0.001);
    }
    ...
    public void testFindStudentsNamesWithBestAverage() {
        ...
        //then
        Assertions.assertEquals(1, studentsNamesWithBestAverage.size());
        Assertions.assertEquals("Kamila Los", studentsNamesWithBestAverage.get(0));
    }
